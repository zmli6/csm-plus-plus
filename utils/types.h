...
enum LRAndIndexCheckType {
    Part1DoLR/*do lr predict whether use indexCheck in Part1*/,
    Part2DoLR/*do lr predict whether use indexCheck in Part2*/,
    Part1JustCheck/*do just check without use lr in part 1*/,
    Part2JustCheck/*do just check without use lr in part 2*/,
